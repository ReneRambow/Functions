...
getal3 = int(input("Voer een getal in "))
getal4 = int(input("Voer een getal in "))
...
getal5 = int(input("Voer een getal in "))
getal6 = int(input("Voer een getal in "))
...
getal7 = int(input("Voer een getal in "))
getal8 = int(input("Voer een getal in "))
...
getal9 = int(input("Voer een getal in"))
...
getal10 = int(input("Voer een getal in"))
